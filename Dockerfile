...
RUN wget https://github.com/mothur/mothur/releases/download/v1.39.5/Mothur.linux_64_static.zip \
&& unzip *.zip && rm Mothur*.zip  && echo "export PATH=$PATH:/mothur" >> /etc/profile
